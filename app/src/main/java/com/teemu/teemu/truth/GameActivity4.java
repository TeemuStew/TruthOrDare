...
public class GameActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTestArray = getResources().getStringArray(R.array.daresCrazy);
        mTestArray2 = getResources().getStringArray(R.array.truthCrazy);
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast toast = Toast.makeText(GameActivity4.this, mTestArray[rando], Toast.LENGTH_LONG);
        ...
        button2.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast toast = Toast.makeText(GameActivity4.this, mTestArray2[rando2], Toast.LENGTH_LONG);
                toast.setGravity(Gravity.TOP |Gravity.CENTER_HORIZONTAL, 0, 0);
                LinearLayout toastLayout = (LinearLayout) toast.getView();
                TextView toastTV = (TextView) toastLayout.getChildAt(0);
                toastTV.setTextSize(30);
